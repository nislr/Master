...
<table class="table table-bordered table-striped" id="dataTable" width="100%" cellspacing="0">
 ...
 <a href="/barang/hapus/{{$brg->kd_brg}}" onclick="return confirm('Ingin menghapus data?')" class="d-none d-sm-inline-block btn btn-sm btn-danger shadow-sm">
...
<div class="modal fade" id="exampleModalScrollable" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
 ...
 <input type="number" name="addqty" id="qty" class="form-control" id="exampleFormControlInput1" >
 </div>
 <div class="form-group">
 <label for="exampleFormControlInput1">Satuan</label>
 <input type="text" name="addsatuan" id="addsatuan" class="form-control" id="exampleFormControlInput1" >
 </div>
 <div class="form-group">
